<template>
  <main>
      ...
      <div class="topmain">
        <el-form ref="form" :model="form" label-width="70px" label-position="left">
          ...
          <el-form-item label="制单人">
            <el-select v-model="form.name" placeholder="选择制单人" size="medium">
              <el-option
                v-for="item in organ"
                :key="item.id"
                :label="item.name"
    ...
    <!-- 弹框 -->
    <el-dialog title="盘点明细列表" :visible.sync="storeDialog" width="1200px" >
      <div class="dialog-main">
        <div class="headInfo">
          <span>创建日期：	2015-04-14 17:07:28</span>

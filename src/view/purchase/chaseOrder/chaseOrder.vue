<template>
  <main>
    ...
    <section class="main-content scroll">
      <div class="topmain">
        <el-form ref="form" :model="form" label-width="70px" label-position="left">
          ...
          <el-form-item label="入库仓">
            <el-select v-model="form.name" placeholder="选择付款方式" size="medium">
              <el-option
                v-for="item in organ"
                :key="item.id"
                :label="item.name"
          ...
          <el-form-item label="到货时间">
            <el-date-picker type="date" placeholder="预计到货时间" size="medium" v-model="form.date" style="width: 100%;"></el-date-picker>
          </el-form-item>
      ...
      <el-button type="primary" size="small" class="addbtn" @click="addBtn">添加采购物料</el-button>
    ...
    <!-- 弹框 -->
    <el-dialog title="添加采购物料" :visible.sync="storeDialog" width="1200px" >
